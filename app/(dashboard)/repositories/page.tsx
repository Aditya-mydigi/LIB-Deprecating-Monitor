    ...
    return (
        <div className="p-8 space-y-8 animate-in fade-in duration-700">
            <header className="flex items-center justify-between pb-8 border-b border-gray-800">
                <div>
                    <h1 className="text-3xl font-black tracking-tighter uppercase italic text-white text-white">Source <span className="text-blue-500 not-italic">Repositories</span></h1>
                    <p className="text-[10px] font-black tracking-[0.3em] text-gray-500 uppercase mt-2">GitHub Restoration // Telemetry Config</p>
                </div>
                <button
                    onClick={handleSave}
                    disabled={saving}
            ...
            <div className="bg-gray-900/10 border border-gray-800 rounded-[48px] p-10 backdrop-blur-xl shadow-2xl">
                {loading ? (
                                ...
                                >
                                    <div className="flex items-center gap-6">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-[10px] text-gray-500 font-bold uppercase tracking-widest mt-1 text-gray-500">Default Branch: {repo.default_branch}</p>
                                        </div>
                                    </div>
                                    {repo.private && (
